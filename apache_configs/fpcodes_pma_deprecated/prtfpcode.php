...
?>
				...
				<!-- <script type="text/javascript" src="<?php echo $curr_dir; ?>jq.js?loc=mbdy&rndstr=<?php echo cache_breaker(20); ?>"> </script> -->
		...
		<img src="<?php echo $curr_dir . "vis1.jpg?loc=mbdy&rndstr=" . cache_breaker(20); ?>" width=1 height=1>
