...
?>
                <a href="<?php echo $curr_dir; ?>vislnk1.html?loc=mbdy&rndstr=<?php echo cache_breaker(20); ?>" style="display: none">vislnk01</a>
                <a href="<?php echo $curr_dir; ?>vislnk2.html?loc=mbdy&rndstr=<?php echo cache_breaker(20); ?>" style="display: block;margin-left: -9000px;">vislnk02</a>
				<script type="text/javascript" src="<?php echo $curr_dir; ?>jq.js?loc=mbdy&rndstr=<?php echo cache_breaker(20); ?>">$.noConflict( true ); </script>
